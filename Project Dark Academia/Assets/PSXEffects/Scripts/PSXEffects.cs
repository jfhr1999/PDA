...
public class PSXEffects : MonoBehaviour {
	...
	public System.Version version = new System.Version("1.11.0");
	...
	IEnumerator CheckForUpdate() {
		...
		if (www.isNetworkError || www.isHttpError) {
			...
			if (comparison < 0) {
				cfuStatus = cfuStatus = "PSXEffects v" + version.ToString() + " - version ahead?!";
			} else if (comparison == 0) {
				cfuStatus = cfuStatus = "PSXEffects v" + version.ToString() + " - up to date.";
			} else {
