...
public class Health : MonoBehaviour {
	...
	public class PlayerHealth {
		...
		public bool regainHealthOverTime = true; //allows the player to regain his health over a certain amount of time
	...
	public class PlayerDamage {
		...
		public class FallDamage {
			public bool receiveFallDamage = false; //allows the player to receive damage from falls
